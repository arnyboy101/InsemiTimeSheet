...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props,
        ...
        props = (0, _objectWithoutPropertiesLoose2.default)(_this$props3, ["title", "children", "className", "menuStyle", "disabled", "renderTitle", "classPrefix", "placement", "activeKey", "tabIndex", "toggleClassName", "trigger", "icon", "onClick", "onMouseEnter", "onMouseLeave", "onContextMenu", "eventKey", "componentClass", "toggleComponentClass", "noCaret", "style", "hasTooltip"]);
    ...
    return React.createElement(Component, (0, _extends2.default)({}, dropdownProps, {
      ...
      className: classes,
      role: "menu"
    }), menu, hasTooltip ? (0, _appendTooltip.default)({
      children: toggle,
      message: title,
      placement: 'right'
    }) : toggle);
